Sample code and instructions on how to build a command line tool that compute the requests rate from log files and push it to Prometheus, a lightweight alternative to mtail and grok_exporter.
